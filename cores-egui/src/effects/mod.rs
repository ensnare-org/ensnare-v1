...
pub struct BiQuadFilterBandPassWidget<'a> {
    filter: &'a mut ensnare_cores::BiQuadFilterBandPass,
}
impl<'a> BiQuadFilterBandPassWidget<'a> {
    fn new_with(filter: &'a mut ensnare_cores::BiQuadFilterBandPass) -> Self {
        Self { filter }
    }
...
pub struct BiQuadFilterBandStopWidget<'a> {
    filter: &'a mut ensnare_cores::BiQuadFilterBandStop,
}
impl<'a> BiQuadFilterBandStopWidget<'a> {
    fn new_with(filter: &'a mut ensnare_cores::BiQuadFilterBandStop) -> Self {
        Self { filter }
    }
...
pub struct BiQuadFilterLowPass24dbWidget<'a> {
    filter: &'a mut ensnare_cores::BiQuadFilterLowPass24db,
}
impl<'a> BiQuadFilterLowPass24dbWidget<'a> {
    fn new_with(filter: &'a mut ensnare_cores::BiQuadFilterLowPass24db) -> Self {
        Self { filter }
    }
...
pub struct BiQuadFilterHighPassWidget<'a> {
    filter: &'a mut ensnare_cores::BiQuadFilterHighPass,
}
impl<'a> BiQuadFilterHighPassWidget<'a> {
    fn new_with(filter: &'a mut ensnare_cores::BiQuadFilterHighPass) -> Self {
        Self { filter }
    }
...
pub struct BiQuadFilterAllPassWidget<'a> {
    filter: &'a mut ensnare_cores::BiQuadFilterAllPass,
}
impl<'a> BiQuadFilterAllPassWidget<'a> {
    fn new(filter: &'a mut ensnare_cores::BiQuadFilterAllPass) -> Self {
        Self { filter }
    }
