...
use ensnare_entity::{factory::EntityFactoryFn, prelude::*, traits::EntityBounds};
...
pub struct BuiltInEntityFactory(EntityFactory<dyn EntityBounds>);
impl BuiltInEntityFactory {
    delegate! {
        to self.0 {
            pub fn register_entity_with_str_key(&mut self, key: &str, f: EntityFactoryFn<dyn EntityBounds>);
        }
    }

    /// Registers all the entities that this factory knows about.
    pub fn register_known_entities(mut self) -> Self {
        // Controllers
        self.0
        ...
        //     });
        self.0
            .register_entity_with_str_key(LfoController::ENTITY_KEY, |uid| {
                Box::new(LfoController::new_with(
                    uid,
                    &LfoControllerParams {
                        frequency: FrequencyHz::from(0.2),
        ...
        self.0
            .register_entity_with_str_key(SignalPassthroughController::ENTITY_KEY, |uid| {
                Box::new(SignalPassthroughController::new(uid))
            });
        self.0
            .register_entity_with_str_key("signal-amplitude-passthrough", |uid| {
                Box::new(SignalPassthroughController::new_amplitude_passthrough_type(
                    uid,
                ))
            });
        self.0
            .register_entity_with_str_key("signal-amplitude-inverted-passthrough", |uid| {
                Box::new(SignalPassthroughController::new_amplitude_inverted_passthrough_type(uid))
            });
        self.0
            .register_entity_with_str_key(Timer::ENTITY_KEY, |uid| {
                Box::new(Timer::new_with(
                    uid,
                    &TimerParams {
                        duration: MusicalTime::DURATION_QUARTER,
        ...
        self.0
            .register_entity_with_str_key(Trigger::ENTITY_KEY, |uid| {
                Box::new(Trigger::new_with(
                    uid,
                    &TriggerParams {
                        timer: TimerParams {
        ...
        // Effects
        self.0
            .register_entity_with_str_key(Bitcrusher::ENTITY_KEY, |_uid| {
                Box::<Bitcrusher>::default()
            });
        self.0
            .register_entity_with_str_key(Chorus::ENTITY_KEY, |_uid| Box::<Chorus>::default());
        self.0
            .register_entity_with_str_key(Compressor::ENTITY_KEY, |_uid| {
                Box::<Compressor>::default()
            });
        self.0
            .register_entity_with_str_key("filter-low-pass-24db", |uid| {
                Box::new(BiQuadFilterLowPass24db::new_with(
                    uid,
                    &BiQuadFilterLowPass24dbParams::default(),
                ))
        ...
        self.0
            .register_entity_with_str_key(Gain::ENTITY_KEY, |uid| {
                Box::new(Gain::new_with(
                    uid,
                    &GainParams {
                        ceiling: Normal::from(0.5),
        ...
        self.0
            .register_entity_with_str_key(Limiter::ENTITY_KEY, |_uid| Box::<Limiter>::default());
        self.0
            .register_entity_with_str_key(Mixer::ENTITY_KEY, |_uid| Box::<Mixer>::default());
        // TODO: this is lazy. It's too hard right now to adjust parameters within
        // code, so I'm creating a special instrument with the parameters I want.
        self.0.register_entity_with_str_key("mute", |uid| {
            Box::new(Gain::new_with(
                uid,
                &GainParams {
                    ceiling: Normal::minimum(),
        ...
        self.0
            .register_entity_with_str_key(Reverb::ENTITY_KEY, |uid| {
                Box::new(Reverb::new_with(
                    uid,
                    &ReverbParams {
                        attenuation: Normal::from(0.8),
        ...
        self.0
            .register_entity_with_str_key(BiQuadFilterLowPass24db::ENTITY_KEY, |uid| {
                Box::new(BiQuadFilterLowPass24db::new_with(
                    uid,
                    &BiQuadFilterLowPass24dbParams {
                        cutoff: FrequencyHz(500.0),
        ...
        // Instruments
        self.0
            .register_entity_with_str_key(Drumkit::ENTITY_KEY, |uid| {
                Box::new(Drumkit::new_with(
                    uid,
                    &DrumkitParams::default(),
                    &Paths::default(),
        ...
        self.0
            .register_entity_with_str_key(FmSynth::ENTITY_KEY, |uid| {
                // A crisp, classic FM sound that brings me back to 1985.
                Box::new(FmSynth::new_with(
                    uid,
                    &FmSynthParams {
        ...
        self.0
            .register_entity_with_str_key(Sampler::ENTITY_KEY, |uid| {
                let mut sampler = Sampler::new_with(
                    uid,
                    &SamplerParams {
                        filename: "stereo-pluck.wav".to_string(),
        ...
        self.0
            .register_entity_with_str_key(WelshSynth::ENTITY_KEY, |uid| {
                Box::new(WelshSynth::new_with(uid, &WelshSynthParams::default()))
            });
